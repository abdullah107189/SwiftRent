...
const NumberCard = ({ name, image, number }) => {
  return (
    <div className="relative h-[300px] w-full md:h-[350px] rounded-3xl overflow-hidden group">
      ...
      <div className="absolute bottom-0 left-0 w-full h-1/3 bg-gradient-to-t from-black/95 via-black/60 to-transparent"></div>

      {/* Service Name */}
      <h2 className="absolute bottom-4 left-[105px] text-white text-lg font-bold z-10">
        {name}
      </h2>
