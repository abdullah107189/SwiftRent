    ...
    <div className="fixed inset-0  bg-opacity-70 flex justify-center items-center z-50">
      <div className="sBgBlack p-6 rounded-lg shadow-lg w-full max-w-2xl">
        ...
        >
          ...
          <div>
            <label className="block text-sm font-medium tBlack">Email*</label>
            <input
              type="email"
          ...
          <div>
            <label className="block text-sm font-medium tBlack">Price*</label>
            <input
              type="text"
          ...
          <div className="md:col-span-2 mt-6">
            <button
              type="submit"
              className="w-full cursor-pointer px-4 py-2 bg-[#f5b754] text-white rounded-md hover:bg-[#e0a33d] focus:outline-none focus:ring-2 focus:ring-[#f5b754]"
            >
              Rent Now
            </button>
          </div>
